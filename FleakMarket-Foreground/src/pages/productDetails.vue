      ...
      <el-col :span="12" :offset="6">
        <div class="pro">
          ...
          <div class="buyer">
            ...
            <div class="pagesmall" @click="refresh">
    ...
    >
      ...
      >
        ...
        <el-row class="orderInfo">
          <el-col :span="10">
            创建日期：<b>{{ order.createtime }}</b>
          </el-col>
          <el-col :span="5">
            订单状态：{{ order.pay === 1 ? "未支付" : "已支付" }}
          </el-col>
        ...
        <div class="productInfo">
          <el-row v-for="item in order.products" :key="item.id">
            ...
            <el-col :span="5" class="infoTop">
              <b>{{ item.name }}</b> <br />
              <span>{{ item.details }}</span>
            </el-col>
            <el-col :span="8" class="infoTop">
              <span
                >工作日、非工作日、全天时段均可配送预计发货后2-4个工作日送达</span
              >
            </el-col>
            <el-col :span="6" class="infoTop">
        ...
        <el-row class="btnClick">
          <el-col :span="3" :offset="9">
            <el-button type="primary" @click="gotoPay(order)"
              >点击支付</el-button
            >
          </el-col>
          <el-col :span="3">
  ...
  methods: {
    ...
    addLove(id) {
      ...
      if (!this.love) {
        //商品添加收藏
        this.$axios
          .post("/product/insertProductToLove", {
            uid: this.$store.state.userid,
            pid: id
          })
          .then(res => {
            ...
            .then(res => {
              if (res.data === 1) {
                ...
                let loading = this.$loading({
                  text:
                    "支付成功，即将跳转个人中心页面，请在我的订单模块查询订单状态..."
                });
                setTimeout(() => {
                  loading.close();
