  ...
  <div class="containerIndex">
    ...
    <el-row class="slide">
      <el-col :span="16" :offset="4">
        <!-- 一级列表-->
        <ul class="slideUl">
          <li v-for="item in fc" :key="item.id" @click="gotoType(item.id)">
            {{ item.name }}<span class="slideUlclick"></span>
          </li>
        </ul>
        <div class="block">
          <el-carousel
        ...
        <div class="hot-product">
          <ul>
            <li v-for="hotpro in hotpros" :key="hotpro.id">
              <p :style="{ borderLeft: '4px ' + hotpro.color }">
                {{ hotpro.name }}
              </p>
              <div :style="{ borderTop: '1px ' + hotpro.color }">
                <ul>
                  <li
                    v-for="item in hotpro.item"
        ...
        <ul class="typeProduct">
          <li v-for="item in newpro" :key="item.id">
            <div class="containerProduct">
              ...
              <div
                class="text"
                style="position: relative;bottom: 0;height: 50px;"
              >
                ...
                <div class="userPlay">
                  <span style="font-size: 12px;color:#bbbcc2;">{{
                    item.creattime
                  }}</span>
                  <span
                    ><button @click="addLove(item.id, item.uid)">
                      点击收藏
                    </button></span
                  >
                </div>
